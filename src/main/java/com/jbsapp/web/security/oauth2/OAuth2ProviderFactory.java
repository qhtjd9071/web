...
import com.jbsapp.web.security.oauth2.provider.GoogleMemberInfo;
...
public class OAuth2ProviderFactory {
    ...
    public static OAuth2UserInfo getOAuth2MemberInfo(OAuth2User oAuth2User, String provider) {
        return switch (provider) {
            case "google" -> new GoogleMemberInfo(oAuth2User.getAttributes());
